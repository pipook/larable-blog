<header class="max-w-4xl mx-auto mt-20 text-center">
    <div class="max-w-xl mx-auto">
        ...
        <h2 class="inline-flex mt-2">By Lary Laracore <img src="/images/lary-head.svg"></h2>
        ...
        <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
                    ...
                    <div x-show="show" class="py-2 absolute bg-gray-100 mt-2 rounded-xl w-full z-50" style="display:none;">
                        ...
                        @foreach($categories as $category)
                            <a 
                                ...
                                class="block text-left px-3 text-sm leading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text-white {{ isset($currentCategory) && $currentCategory->is($category) ? 'bg-blue-500' : '' }}"
                            >
            ...
            <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
                <select class="appearance-none bg-transparent py-2 pl-3 pr-9 text-sm font-semibold">
